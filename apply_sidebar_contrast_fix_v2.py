...
ROOT = Path.cwd()
styles_path = ROOT / 'ui_styles.py'
if not styles_path.exists():
    raise FileNotFoundError('ui_styles.py not found. Run this from the Rangers_Streamlit_Hub folder.')
...
print('Updated ui_styles.py with stronger sidebar/uploader contrast rules.')
